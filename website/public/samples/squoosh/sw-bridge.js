    ...
    [0], {
        54: function(e, t, n) {
            ...
            class r {
                ...
                _withIDBStore(e, t) {
                    return this._dbp.then(n => new Promise((r, a) => {
            ...
            n.r(t),
                function(e) {
                    ...
                    function i() {
                        return new Promise(e => {
                            const t = n => {
                                "load-image" === n.data.action && (e(n.data.file),
                    ...
                    async function o(t) {
                        ...
                        if (navigator.serviceWorker.addEventListener("controllerchange", async () => {
                                n ? location.reload() : t("Ready to work offline", {
                                    timeout: 5e3
                                })
                            }),
                            !n)
                        ...
                        r && (await a(r),
                            "reload" === await t("Update available", {
                    ...
                    async function s() {
                        if (await Object(r.a)("user-interacted"))
                            return;
...
//# sourceMappingURL=sw-bridge.6d7ee.js.map
